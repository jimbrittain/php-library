...
if (!class_exists('IMRestrictToPagesPlugin')) {
    class IMRestrictToPagesPlugin
    {
        ...
        public function __construct()
        {
            ...
            require_once(sprintf("%s/inc/is_login_page.php", dirname(__FILE__)));
        ...
        public static function activate()
        {
            if (function_exists('add_option')) {
                $temp = self::get();
                $created = add_option(self::$optname, $temp);
                if (!$created) {
                    $temp->enabled = true;
                    update_option(self::$optname, $temp);
                }
            }
        }
